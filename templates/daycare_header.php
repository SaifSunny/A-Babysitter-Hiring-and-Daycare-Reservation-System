                    ...
                    <div class="app-utilities col-auto" style="margin-right:60px;margin-top:4px;">
                        ...
                        <div class="app-utility-item app-user-dropdown dropdown">
                            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                role="button" aria-expanded="false"><span style="font-size:16px; font-weight:700px;color:black;font-family:poppins;">@<?php echo $username;?> </span><img src="./img/daycares/<?php echo $image;?>"
                                    alt="user profile" style="border-radius:20%;"></a>
                            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                <li><a class="dropdown-item" href="daycare_profile.php">My Profile</a></li>
                                <li>
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    <li class="nav-item">
                        <a class="nav-link" href="daycare_home.php">
