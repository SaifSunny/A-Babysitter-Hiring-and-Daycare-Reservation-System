...
<head>
    <title>Manage Users - Kidcare</title>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <div class="d-flex justify-content-between" style="padding:20px 40px">
                    ...
                    <div>
                        <a href="admin_add_user.php" class="btn app-btn-primary">Add User</a>
                    </div>
                </div>
                <!--  Card-->
                                ...
                                <table class="table" style="font-size: 14px;text-align:center;">
                                    ...
                                    <tbody>
                                        <?php 
											...
											?>
                                        <tr>
                                            <td><img src="./img/users/<?php echo $image ?>"
                                            ...
                                            <td><a href="admin_delete_user.php?id=<?php echo $id?>"
