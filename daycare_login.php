...
if (isset($_SESSION['daycarename'])) {
    header("Location: daycare_home.php");
}
...
if (isset($_POST['submit'])) {
	...
	if ($result->num_rows > 0) {
        ...
        $sql = "SELECT * FROM daycare WHERE `password`='$password'";
        $result = mysqli_query($conn, $sql);
        ...
        if ($result->num_rows > 0) {
            ...
            if ($result->num_rows > 0) {
                $_SESSION['daycarename'] = $_POST['username'];

                $sql = "INSERT INTO latest_users(`image`, `name`, `role`) VALUES ((SELECT `image` FROM daycare WHERE username='$username'), '$username', 'Daycare')";
                $result = mysqli_query($conn, $sql);
                if($result){
                    header("Location: daycare_home.php");
                }
                ...
                <div class="app-auth-body mx-auto">
                    ...
                    <div class="auth-form-container text-start">
                        ...
                        <div class="auth-option text-center pt-5">Don't Have a Account? <a class="text-link"
                                href="daycare_signup.php">Sign Up Now</a>.</div>
                    </div> 
