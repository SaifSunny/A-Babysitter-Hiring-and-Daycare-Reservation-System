...
<head>
    <title>Manage Babysitter - Kidcare</title>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <div class="d-flex justify-content-between" style="padding:20px 40px">
                    <div>
                        <h1 class="app-page-title">Manage Babysitters</h1>
                    </div>
                    <div>
                        <a href="admin_add_babysitter.php" class="btn app-btn-primary">Add Babysitter</a>
                    </div>
                </div>
                <!--  Card-->
                                ...
                                <table class="table" style="font-size: 14px;text-align:center;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="admin_delete_babysitter.php?id=<?php echo $id?>"
