...
$_SESSION['sitter_id'] = $row['sitter_id'];
...
if (isset($_POST['submit_play'])) {
    ...
    // Update Record
    $query2 = "UPDATE hire_babysitter SET status=0 WHERE babysitter_id='$sitter_id' AND incare=1";
...
if (isset($_POST['submit_food'])) {
    ...
    // Update Record
    $query2 = "UPDATE hire_babysitter SET status=1 WHERE babysitter_id='$sitter_id' AND incare=1";
    $query_run2 = mysqli_query($conn, $query2);
...
if (isset($_POST['submit_book'])) {
    ...
    // Update Record
    $query2 = "UPDATE hire_babysitter SET status=2 WHERE babysitter_id='$sitter_id' AND incare=1";
    $query_run2 = mysqli_query($conn, $query2);
...
if (isset($_POST['submit_bed'])) {
    ...
    // Update Record
    $query2 = "UPDATE hire_babysitter SET status=3 WHERE babysitter_id='$sitter_id' AND incare=1";
    $query_run2 = mysqli_query($conn, $query2);
...
<head>
    <title>Babysitter Home - Kidcare</title>
                        ...
                        <div class="app-card app-card-chart h-100 shadow-sm">
                            <div class="app-card-header p-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <h4 class="app-card-title" style="margin-left:30px;">Babys Incare</h4>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="app-card-body p-3 p-lg-4">
                                <div class="chart-container">
                                    <?php 
                                            $sql = "SELECT * FROM hire_babysitter WHERE `babysitter_id`=$sitter_id AND incare=1";
                                            $result = mysqli_query($conn, $sql);
                                            if($result){
